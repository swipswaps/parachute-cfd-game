...
# ----------------------------------------------------------------------
# apply_fixlist_0026.sh – Complete self‑healing CFD‑to‑Godot pipeline
# - Installs raster2mesh from GitHub (not PyPI).
# - All other steps identical to v0025.
# ----------------------------------------------------------------------
...
# Git (needed to install raster2mesh from GitHub)
...
# ----------------------------------------------------------------------
# First, install raster2mesh from GitHub (not available on PyPI)
run_step "Install raster2mesh from GitHub" \
    "command -v raster2mesh" \
    "python3 -m pip install --user git+https://github.com/patrickkidd/raster2mesh.git" \
    "command -v raster2mesh"
