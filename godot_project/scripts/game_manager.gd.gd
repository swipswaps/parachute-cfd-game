...
func _input(_event) -> void:
	print("[INPUT] game_manager.gd.gd:66 _input/_unhandled_input triggered")
	print("[INPUT] game_manager.gd.gd:66 _input/_unhandled_input triggered")
	print("[INPUT] game_manager.gd.gd:66 _input/_unhandled_input triggered")
	print("[INPUT] game_manager.gd.gd:186 _input/_unhandled_input triggered")
	print("[INPUT] game_manager.gd.gd:186 _input/_unhandled_input triggered")
	print("[INPUT] game_manager.gd.gd:186 _input/_unhandled_input triggered")
	print("[INPUT] game_manager.gd.gd:186 _input/_unhandled_input triggered")
	"""
	...
	if not parachute:
		_log("WARN: parachute is null — skipping block")
		return
...
func calculate_score() -> void:
	...
	# Calculate bonuses
	var flight_time = OS.get_ticks_msec() / 1000.0  # Simplified
