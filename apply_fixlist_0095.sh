...
# ----------------------------------------------------------------------
# apply_fixlist_0095.sh – Complete self‑healing CFD‑to‑Godot pipeline v95
# v95 : adds single‑line blockMeshDict pattern, mesh retry loop, auto DB dump,
#       backslash fix, schema versioning, fuzzy matching, unknown logging.
# ----------------------------------------------------------------------

REPO_ROOT="$(pwd)"
echo "=== Parachute CFD Landing Game – Self‑Healing v95 (complete) ==="
...
PATTERNS = [
    ...
    # pattern for blockMeshDict missing – matches the path line (second line of FOAM FATAL ERROR)
    (r"system/blockMeshDict", "Missing system/blockMeshDict (path line)",
...
# --------------- Python helpers (unchanged from v93) ---------------
...
main() {
    ...
    launch_godot_step
    perform_llm_audit
    echo "=== All steps completed successfully (v95) ==="
}
