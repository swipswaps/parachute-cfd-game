...
# ----------------------------------------------------------------------
# apply_fixlist_0010.sh – Fully compliant with prf.fixlist.v6
...
# - Adds pycollada and fast_simplification for trimesh .dae export and decimation.
...
# ----------------------------------------------------------------------
# TEST-001 – verify collada_to_stl with a cube (requires fast_simplification)
