...
# ----------------------------------------------------------------------
# apply_fixlist_0023.sh – Complete self‑healing CFD‑to‑Godot pipeline
# - Fixed ParaView step: uses /tmp/pvpy_setup.sh to avoid unbound variable.
# - All other steps identical to v0022.
# ----------------------------------------------------------------------
