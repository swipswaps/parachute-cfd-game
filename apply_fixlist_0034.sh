...
# ----------------------------------------------------------------------
# 8. User input (with Google Earth launcher and alt location support)
# ----------------------------------------------------------------------
