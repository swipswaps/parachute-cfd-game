...
# ----------------------------------------------------------------------
# apply_fixlist_0028.sh – Complete self‑healing CFD‑to‑Godot pipeline
# - Removes broken osm2world, blender, git steps (manual DAE only).
# - User must provide a COLLADA (.dae) file from Google Earth Pro.
# - All other steps identical to v0027.
# ----------------------------------------------------------------------
