...
# ----------------------------------------------------------------------
# apply_fixlist_0016.sh – Idempotent, self‑healing CFD‑to‑Godot automation
# Requires OpenFOAM environment to be active (run 'ofsrc' first).
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# 0b. Check that OpenFOAM environment is active
# ----------------------------------------------------------------------
